 ...
 */
final class Version20251125203718 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `character` (id INT AUTO_INCREMENT NOT NULL, class_id INT DEFAULT NULL, active_spec_id INT DEFAULT NULL, user_id INT NOT NULL, character_name VARCHAR(255) NOT NULL, character_realm_slug VARCHAR(255) NOT NULL, character_region VARCHAR(255) NOT NULL, level INT DEFAULT NULL, thumbnail VARCHAR(255) DEFAULT NULL, INDEX IDX_937AB034EA000B10 (class_id), INDEX IDX_937AB03429C318E5 (active_spec_id), INDEX IDX_937AB034A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, date_debut DATETIME NOT NULL, nb_places_max INT NOT NULL, tanks_requis INT NOT NULL, soigneurs_requis INT NOT NULL, dps_requis INT NOT NULL, INDEX IDX_B26681EBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, evenement_id INT NOT NULL, specialization_id INT DEFAULT NULL, statut VARCHAR(255) NOT NULL, played_role VARCHAR(50) DEFAULT NULL, INDEX IDX_5E90F6D6A76ED395 (user_id), INDEX IDX_5E90F6D6FD02F13 (evenement_id), INDEX IDX_5E90F6D6FA846217 (specialization_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, active_character_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, guild_rank VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F06CD998 (active_character_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `character` ADD CONSTRAINT FK_937AB03429C318E5 FOREIGN KEY (active_spec_id) REFERENCES specialization (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `character` DROP FOREIGN KEY FK_937AB03429C318E5');
